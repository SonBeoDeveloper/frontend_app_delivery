...
const FavoriteCard = ({_id, name, description, price, images, navigate}) => {
      ...
      <View style={styles.detailsContainer}>
        <TouchableOpacity onPress={() => navigate()} activeOpacity={0.8}>
          <View style={styles.rowContainer}>
            ...
            <TouchableOpacity onPress={() => toggleHeartColor(_id)}>
              <Ionicons
                name="heart"
                size={20}
                color={isHeartRed ? Colors.DEFAULT_GREY : Colors.DEFAULT_RED}
              />
            </TouchableOpacity>
          </View>
