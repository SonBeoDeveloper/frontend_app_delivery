  ...
  return (
    <View
      ...
      <View style={styles.headerContainer}>
        ...
        />
        <Text style={styles.headerTitle}>Xác minh số điện thoại</Text>
      </View>
      <Text style={styles.title}>Đổi mật khẩy</Text>
      <Text style={styles.content}>Nhập số điện thoại cần đổi mật khẩu.</Text>
      <View
      ...
      <TouchableOpacity
        ...
        activeOpacity={0.8}
        onPress={() =>
          navigation.navigate('Verification', {phoneNumber, userEmail})
        }>
